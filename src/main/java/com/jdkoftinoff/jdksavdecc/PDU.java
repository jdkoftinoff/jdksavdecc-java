...
public class PDU {
	...
	PDU( ByteBuffer data, byte destination_address[], byte source_address[], short ethertype ) {
	...
	public final static int getLength( ByteBuffer data) {
	...
	public final static boolean getBit( ByteBuffer data, int start_offset, int bitnum_from_msb ) {
	...
	public boolean getBit( int start_offset, int bitnum_from_msb ) {
		return getBit(data,start_offset,bitnum_from_msb);
	}
	
	public final static void setBit( ByteBuffer data, int start_offset, int bitnum_from_msb, boolean newValue ) {
		int additional = bitnum_from_msb/8;
		int leftover = bitnum_from_msb&7;
		byte mask = (byte)(0x80 >> leftover);
	...
	public void setBit( int start_offset, int bitnum_from_msb, boolean newValue ) {
		setBit( data, start_offset, bitnum_from_msb, newValue );
	}
	
	public final static int getBitField( ByteBuffer data, int start_offset, int mask, int shift ) {
		int v=(data.getInt(start_offset)>>shift) & mask;
		return v;
	}

	public int getBitField( int start_offset, int mask, int shift ) {
		return getBitField(data,start_offset,mask,shift);
	}

	public final static void setBitField( ByteBuffer data, int start_offset, int mask, int shift, int value ) {
		int orig=data.getInt(start_offset) & (~ (mask<<shift) );
		int v=((value&mask)<<shift);
		data.putInt(start_offset, orig | v);
	}

	public void setBitField( int start_offset, int mask, int shift, int value ) {
		setBitField( data, start_offset, mask, shift, value );
	}	
	
	public final static byte[] getEUI64Field( ByteBuffer data, int start_offset ) {
		byte r[] = new byte[8];
		data.get(r, start_offset, 8);
		return r;
	}

	public final static byte getOctetField( ByteBuffer data, int start_offset ) {
	...
	public final static void setOctetField( ByteBuffer data, int start_offset, byte newValue ) {
		data.put(start_offset, newValue);
	}
	
	public void setOctetField(  int start_offset, byte newValue ) {
		setOctetField(data,start_offset,newValue);
	}
	
	public final static short getDoubletField( ByteBuffer data, int start_offset ) {
	...
	public final static void setDoubletField( ByteBuffer data, int start_offset, short newValue ) {
		data.putShort(start_offset, newValue);
	}
	
	public void setDoubletField(  int start_offset, short newValue ) {
		setDoubletField(data,start_offset,newValue);
	}

	
	public final static int getQuadletField( ByteBuffer data, int start_offset ) {
	...
	public final static void setQuadletField( ByteBuffer data, int start_offset, int newValue ) {
		data.putInt(start_offset, newValue);
	}
	
	public void setQuadletField(  int start_offset, int newValue ) {
		setQuadletField(data,start_offset,newValue);
	}

	
	public final static long getOctletField( ByteBuffer data, int start_offset ) {
	...
	public final static void setOctletField( ByteBuffer data, int start_offset, long newValue ) {
		data.putLong(start_offset, newValue);
	}
	
	public void setOctletField(  int start_offset, long newValue ) {
	...
	public final static void setEUI64Field( ByteBuffer data, int start_offset, byte eui64[] ) {
		data.put(eui64, start_offset, 8);
	}

	public void setEUI64Field( int start_offset, byte eui64[] ) {
		setEUI64Field( data, start_offset, eui64 );
	}
	
	public final static byte[] getEUI48Field( ByteBuffer data, int start_offset ) {
		byte r[] = new byte[6];
		data.get(r, start_offset, 6);
		return r;
	}

	public byte[] getEUI48Field( int start_offset ) {
		return getEUI48Field( data, start_offset );
	}

	public final static void setEUI48Field( ByteBuffer data, int start_offset, byte eui48[] ) {
		data.put(eui48, start_offset, 6);
	}

	public void setEUI48Field( int start_offset, byte eui48[] ) {
