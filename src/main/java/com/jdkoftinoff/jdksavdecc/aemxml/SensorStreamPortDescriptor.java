 ...
 * 
 * <p>Java class for SensorStreamPortDescriptor complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SensorStreamPortDescriptor">
 *   &lt;complexContent>
 ...
 *         &lt;element name="clusters" type="{http://grouper.ieee.org/groups/1722/1/contributions/xml}SensorClusterDescriptors"/>
 *         &lt;element name="maps" type="{http://grouper.ieee.org/groups/1722/1/contributions/xml}SensorMapDescriptors" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "SensorStreamPortDescriptor", propOrder = {
    "clockDomainIndex",
    "portFlags",
    "controls",
    "clusters",
...
public class SensorStreamPortDescriptor {
    ...
    protected SensorClusterDescriptors clusters;
    protected List<SensorMapDescriptors> maps;
     ...
     * @return
     *     possible object is
     *     {@link SensorClusterDescriptors }
     *     
     */
    public SensorClusterDescriptors getClusters() {
        return clusters;
    }
     ...
     *     
     */
    public void setClusters(SensorClusterDescriptors value) {
        this.clusters = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SensorMapDescriptors }
     * 
     * 
     */
    public List<SensorMapDescriptors> getMaps() {
        if (maps == null) {
            maps = new ArrayList<SensorMapDescriptors>();
        }
        return this.maps;
    }
