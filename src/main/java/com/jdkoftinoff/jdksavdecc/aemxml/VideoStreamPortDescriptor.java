 ...
 * 
 * <p>Java class for VideoStreamPortDescriptor complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="VideoStreamPortDescriptor">
 *   &lt;complexContent>
 ...
 *         &lt;element name="clusters" type="{http://grouper.ieee.org/groups/1722/1/contributions/xml}VideoClusterDescriptors"/>
 *         &lt;element name="maps" type="{http://grouper.ieee.org/groups/1722/1/contributions/xml}VideoMapDescriptors" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "VideoStreamPortDescriptor", propOrder = {
    "clockDomainIndex",
    "portFlags",
    "controls",
    "clusters",
...
public class VideoStreamPortDescriptor {
    ...
    protected VideoClusterDescriptors clusters;
    protected List<VideoMapDescriptors> maps;
     ...
     * @return
     *     possible object is
     *     {@link VideoClusterDescriptors }
     *     
     */
    public VideoClusterDescriptors getClusters() {
        return clusters;
    }
     ...
     *     
     */
    public void setClusters(VideoClusterDescriptors value) {
        this.clusters = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VideoMapDescriptors }
     * 
     * 
     */
    public List<VideoMapDescriptors> getMaps() {
        if (maps == null) {
            maps = new ArrayList<VideoMapDescriptors>();
        }
        return this.maps;
    }
